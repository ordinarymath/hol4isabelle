theory Kernel_Sig_Isa
imports Main Prekernel.Prekernel
begin
...
in
fun prove_typedef_hol4 exI typedef_thm typedef_equiv obligation =
  let val thm1 = typedef_thm RS typedef_equiv
