theory Bool_Kernel_Isa
imports Postkernel_Isa Splice
begin
...
lemma type_definition_equiv:
  assumes tydef:"type_definition r a (Collect A)"
  shows "HOL4\<open>TYPE_DEFINITION\<close> A r"
